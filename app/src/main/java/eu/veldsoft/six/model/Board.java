...
final public class Board {
	...
	/**
	 * The number of tiles each player has.
	 */
	private static final int PLAYER_NUMBER_OF_TILES = 21;
	...
	/**
	 * List of the tiles to be distributed to the players.
	 */
	...
	public Board() {
		...
		for(int i=0; i<PLAYER_NUMBER_OF_TILES; i++) {
